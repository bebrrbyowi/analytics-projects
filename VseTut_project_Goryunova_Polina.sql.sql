...
--агрегирование заказов по пользователю
ooo AS (
...
--пользовательские метрики + рейтинг
...
SELECT user_id, region, first_order_ts, last_order_ts, lifetime, total_orders, avg_order_rating, num_orders_with_rating, num_canceled_orders, canceled_orders_ratio, total_order_costs, avg_order_cost, num_installment_orders, num_orders_with_promo, used_money_transfer, used_installments, used_cancel
FROM full_base
